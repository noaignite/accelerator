...
<Callout>
  Any `.md` or `.mdx` file will turn into a doc page and be displayed in sidebar. You can also
  create a `_meta.js` file to customize the page order and title. <br /> Check the source code:
  https://github.com/shuding/nextra for more information.
</Callout>
