...
import { MediaBreakpoint, MediaProps, MediaTypeMap } from './MediaProps'

/**
 * @ignore - internal component.
 */
const MediaWithWidth = React.forwardRef(function MediaWithWidth(props: MediaProps, ref) {
  ...
  const src = keys.reduce((output: MediaBreakpoint | null | undefined, key: Breakpoint) => {
