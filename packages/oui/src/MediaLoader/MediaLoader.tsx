...
import mediaLoaded, { MLEntry } from '@maeertin/medialoaded'
import { OverridableComponent } from '@mui/types'
import { setRef } from '@mui/material/utils'
import { MediaLoaderProps, MediaLoaderTypeMap } from './MediaLoaderProps'

const MediaLoader = React.forwardRef(function MediaLoader(props: MediaLoaderProps, ref) {
