...
- aefdd31: Deps: bump `eslint-plugin-turbo` from 2.7.5 to 2.8.11
...
- 2900cc6: Prettier: Fix plugin resolution when consuming the shared config from another project.
